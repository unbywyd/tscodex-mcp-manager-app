...
import { Key, Plus, Trash2, Eye, EyeOff, Save, AlertCircle, Info } from 'lucide-react';
...
export function ServerSecretsManager({
  ...
  const deleteSecret = async (index: number) => {
    ...
    // If it's an existing secret (not new), delete from storage

/**
 * ConnectionTab - AI Provider connection settings
 */
...
export function ConnectionTab({ onSuccess }: ConnectionTabProps) {
    ...
    <div className="flex justify-center">
      <div className="w-full max-w-lg space-y-4">
        <p className="text-sm text-gray-400">
          Configure your OpenAI-compatible API provider. The API key is stored securely
          and never exposed to MCP servers.
        </p>
      ...
      <div>
        ...
        <p className="text-xs text-gray-500 mt-1">
          OpenAI-compatible API endpoint (e.g., OpenAI, OpenRouter, Groq, Ollama)
        </p>
      </div>
      ...
      <div>
        ...
        {hasExistingKey && (
          <p className="text-xs text-gray-500 mt-1">
            Leave empty to keep existing key, or enter new key to replace
          </p>
        )}
      </div>
      ...
      <div>
        ...
        />
        <p className="text-xs text-gray-500 mt-1">
          Model to use when MCP servers don't specify one
        </p>
      </div>
      ...
      <div className="pt-2 flex gap-2">
        <button
          ...
          className="flex items-center justify-center gap-1.5 px-4 py-2 text-red-400 hover:text-red-300 hover:bg-red-500/10 border border-red-500/30 rounded-md transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
